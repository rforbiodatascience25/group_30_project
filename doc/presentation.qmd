---
title: "α-Synuclein Aggregates in Parkinson’s Disease"
...
.reveal .slides section table {
  width: 100% !important;                   /* gør så at tabellen fylder hele vejen */
...
![](images/pivotlonger_example.png){fig-align="left" width="600"}
...
::::: columns
::: {.column .wide-bullets width="40%"}
-   Fmax_mean <br><br><br>

-   Statistically significant difference in both 24h and 150h SAA <br><br><br>

-   AUC, SLOPE, T50 and TTT <br><br><br>
:::

::: {.column width="60%"}
![](../results/06_fmax_mean_results_24h.png){width="600"}

![](../results/06_fmax_mean_results_150h.png){width="600"}
:::
:::::
...
![](../results/07_sd_by_instrument.png)
:::
