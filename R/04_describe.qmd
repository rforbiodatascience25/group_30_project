...
### Saa-result from all observation, patient repeats accepted
...
result_distribution <- aug_data |>
  ...
  scale_fill_manual(values = c("#94BFBE","#C03221","#627634"),
                    name = "Result",
...
low_range(saa_aug_data, fmax, 50)
low_range(saa_aug_data, auc, 50)
low_range(saa_aug_data, ttt, 50)
```
...
# The function returns 2 values: one from project 155 and one from 237:
high_range(saa_aug_data, fmax, 50)
high_range(saa_aug_data, auc, 50)
high_range(saa_aug_data, ttt, 50)
```
